  ...
  return (
    <div className='w-11/12 mx-auto py-5 flex justify-between items-center'>
      ...
      <div className='flex items-center justify-end space-x-3'>
        ...
        <button className='text-[#FF3811] font-semibold text-lg px-4 py-2 border-2 border-[#FF3811] rounded-lg hover:text-white hover:bg-[#FF3811] cursor-pointer'>Appointment</button>
      </div>
    </div>
  )
}
