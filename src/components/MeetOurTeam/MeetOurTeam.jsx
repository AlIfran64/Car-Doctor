...
export default function MeetOurTeam() {
  return (
    <div className='w-11/12 mx-auto my-25'>
      <h1 className='text-[#FF3811] text-xl font-bold text-center mb-5'>Team</h1>
      <p className='text-5xl font-bold mb-5 text-center'>Meet Our Team</p>
      ...
      <div className='relative'>
        ...
        <button
          className="bg-[#FF3811] p-2 lg:p-4 rounded-full text-white cursor-pointer absolute -top-50 -right-7"><GoArrowLeft className="transform rotate-180" /></button>
      </div>
